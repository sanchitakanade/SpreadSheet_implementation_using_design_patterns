...
public class ValueViewObserverD implements ActionListener {
    private ValueViewGUI valueView;
    private String expression;

    public ValueViewObserverD(ValueViewGUI valueView) {
        this.valueView = valueView;
        valueView.getjTextField4().addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        valueView.getjTextField4().setText(interpreter.interpretPostfixExpression(valueView.getInputString(variables)));
