...
public class ValueViewObserverC implements ActionListener {
    private ValueViewGUI valueView;
    private String expression;

    public ValueViewObserverC(ValueViewGUI valueView) {
        this.valueView = valueView;
        valueView.getjTextField3().addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        valueView.getjTextField3().setText(interpreter.interpretPostfixExpression(valueView.getInputString(variables)));
