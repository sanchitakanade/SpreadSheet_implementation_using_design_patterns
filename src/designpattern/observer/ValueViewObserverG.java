...
public class ValueViewObserverG implements ActionListener {
    private ValueViewGUI valueView;
    private String expression;

    public ValueViewObserverG(ValueViewGUI valueView) {
        this.valueView = valueView;
        valueView.getjTextField6().addActionListener(this);
    }
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        valueView.getjTextField6().setText(interpreter.interpretPostfixExpression(valueView.getInputString(variables)));
